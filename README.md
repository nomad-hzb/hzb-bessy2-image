![docker image](https://github.com/nomad-hzb/hzb-bessy2-image/actions/workflows/docker-publish.yml/badge.svg)
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/nomad-hzb/hzb-bessy2-image.git
    cd hzb-bessy2-image
    ```
    ...
    ```sh
    curl-L -o hzb-bessy2-image.zip "https://github.com/nomad-hzb/hzb-bessy2-image/archive/main.zip"
    unzip hzb-bessy2-image.zip
    cd hzb-bessy2-image
    ```
...
your `docker-compose.yaml` with `ghcr.io/nomad-hzb/hzb-bessy2-image:main` for the services
...
and advanced configuration, see the [nomad-helm-charts](https://github.com/nomad-hzb/nomad-helm-charts) repository.
...
By default, no plugins are included in this distribution. You can find a list of available NOMAD plugins [here](https://nomad-lab.eu/prod/v1/oasis/gui/search/plugins). For a list of official plugins provided by FAIRmat, please see [here](https://github.com/nomad-hzb/.github/blob/main/profile/README.md). For inspiration, you can also check the list of [plugins that are installed on the production NOMAD deployment hosted by FAIRmat](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-distro/-/raw/main/pyproject.toml?ref_type=heads).
...
```sh
docker pull ghcr.io/nomad-hzb/hzb-bessy2-image/jupyter:main
```
...
By default, documentation is built using the [nomad-docs](https://github.com/nomad-hzb/nomad-docs) repository. However, if you'd like to customize the documentation for your Oasis instance, you can easily do so.

1. First, [fork the nomad-docs repository](https://github.com/nomad-hzb/nomad-docs/fork).
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/nomad-hzb/hzb-bessy2-image/manifests/main": unauthorized`
